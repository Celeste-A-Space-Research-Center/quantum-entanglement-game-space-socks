...
# Sound
pygame.mixer.music.load(r"./quantum-entanglement-game-space-socks-main/assets\background.wav")
...
yellowsock=pygame.image.load(r"./quantum-entanglement-game-space-socks-main/pics/yellowsock-pic (1).png")
...
sship=pygame.image.load(r"./quantum-entanglement-game-space-socks-main/pics/yellowsock-pic (1).png")
